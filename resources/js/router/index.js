    ...
    },
{
    ...
    children: [
        {
            path: "", // default child (berarti "/validator/dashboard")
            name: "dashboard", // Pindahkan name ke sini
        ...
        {
            path: "home", // tanpa garis miring awal
            name: "Home",
            component: () => import("../pages/dashboard/Home/Home.vue"),
            meta: {
                title: "Home",
        ...
        },
        {
            ...
            component: () =>
                import("../pages/dashboard/Home/DashboardValidasi.vue"),
            meta: {
