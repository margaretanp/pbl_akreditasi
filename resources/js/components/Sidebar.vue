          ...
          <li>
            ...
            >
              <div class="flex items-center">
                ...
                <span v-if="expanded" class="ml-3">Kriteria</span>
              </div>
              <svg
                v-if="expanded"
                class="w-4 h-4 transition-transform duration-200"
                :class="{ 'transform rotate-180': showKriteria }"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            >
              <li v-for="i in 9" :key="i">
                <router-link :to="`/kriteria${i}`">Kriteria {{ i }}</router-link>
              </li>
            </div>
          </li>
...
export default {
  ...
  methods: {
    ...
    async handleLogout() {
      ...
      this.$router.push({ name: 'welcome' }); // redirect ke landing page
